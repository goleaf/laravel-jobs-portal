...
class ShowJobApplicationApiRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for ShowJobApplicationApiRequest', [
