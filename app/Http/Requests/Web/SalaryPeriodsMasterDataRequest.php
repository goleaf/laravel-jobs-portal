...
class SalaryPeriodsMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for SalaryPeriodsMasterDataRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'MasterDataController',
            'method' => 'salaryPeriods',
