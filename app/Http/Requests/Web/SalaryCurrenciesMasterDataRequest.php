...
/**
 * Enhanced Enhanced Form Request for MasterData salaryCurrencies
 * Implements Laravel 12 best practices with Enhanced MCP patterns
 * Auto-generated for Level 4 Complex System Transformation.
 */
class SalaryCurrenciesMasterDataRequest extends FormRequest
{
    /**
    ...
    {
        logger()->warning('Enhanced validation failed for SalaryCurrenciesMasterDataRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'MasterDataController',
            'method' => 'salaryCurrencies',
