...
/**
 * Universal Form Request for deleting JobStage
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class DeleteJobStageRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('JobStage'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteJobStageRequest', [
