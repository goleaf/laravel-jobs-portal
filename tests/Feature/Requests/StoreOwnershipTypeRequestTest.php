...
/**
 * Universal Enhanced Validation Tests for StoreOwnershipTypeRequest
 * 
 * @group validation
 * @group requests
 */
class StoreOwnershipTypeRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreOwnershipTypeRequest();
