...
use Tests\TestCase;
use App\Http\Requests\MasterData\StoreCareerLevelRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for StoreCareerLevelRequest
 * Testing validation rules and authorization
 */
class StoreCareerLevelRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreCareerLevelRequest();
