...
@section('content')
    <div class="home-page">
            ...
            <section class="hero-section relative">
                <div id="carouselExampleControlshero" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        @foreach ($headerSliders as $key => $headerSlider)
                            <div class="bg-image carousel-item {{ $key == 0 ? 'active' : '' }} position-relative pt-100 pb-150"
                                style="position: relative;background-image: url({{ $headerSlider->header_slider_url }});height:624px;flex-1 px-4or: white; text-align: center;">
                            </div>
                        @endforeach
                        <div class="hero-content- flex flex-wrap flex flex-wrap w-full">
                            <div class="flex-1 lg-6 text-center">
                                <div class="hero-contentt mt-lg-0 mt-md-5 my-4">
                                    ...
                                    <h1 class="fs-44 mb-md-4 mb-3 text-indigo-600 -600 fw-bold">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControlshero"
                        data-bs-slide="prev">
                        <i class="icon fa-solid fa-arflex flex-wrap -mx-4-left text-white"></i>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlshero"
                        data-bs-slide="next">
                        <i class="icon fa-solid fa-arflex flex-wrap -mx-4-right text-white"></i>
                    </button>
                </div>
            </section>
        @else
            <section class="hero-section relative bg-gradient pt-100 pb-150">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto">
                    <div class="flex flex-wrap mx-2 items-center flex-flex-1 px-4umn-reverse flex-lg- flex flex-wrap">
                                ...
                                <div class="flex flex-wrap items-center justify-content-around m-0">
                                    <div class="flex-1 lg-5 br-2 ps-lg-4 px-20">
                                        ...
                                        <div id="jobsSearchResults" class="absolute w100 job-search" style="display: none;">
                                            <ul class="job-search- relative inline-block text-left flex space-x-1 submenu">
                                            </ul>
                                        </div>
                                    </div>
        ...
        @if (count($imageSliders) > 0 && $imageSliderActive->value)
            <section class="{{ $slider->value == 0 ? ' max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 ' : ' ' }} slider-test-section position-relative mb-80">
                    ...
                    <div class="job-categories- bg-white shadow rounded -lg overflow-hidden">
                        <div class="flex flex-wrap">
                            @foreach ($jobCategories as $jobCategory)
                                <div class="flex-1 -xl-3 lg:w-4/12 px-2 flex-1 md-6 mb-40 px-xl-3">
                                    <div class="bg-white shadow rounded -lg overflow-hidden px-20">
                                        ...
                                        <div class="bg-white shadow rounded -lg overflow-hidden body text-center">
                                            ...
                                            @else
                                                <a href="{{ route('front.', ['categories' => $jobCategory->id]) }}"
                                                    class="bg-white shadow rounded -lg overflow-hidden text fs-14 text-gray text-indigo-600 -600">
                        ...
                        <div class="flex flex-wrap justify-center">
                            <div class="flex-1 -12 text-center">
                                <a class="border border-gray-300 bg-transparent"
                                    href="{{ route('front.', ['is_featured' => true]) }}">
                                    @lang('web.common.bflex flex-wrap -mx-4se_all')
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="job- bg-white shadow rounded -lg overflow-hidden">
                        <div class="flex flex-wrap">
                            ...
                            @foreach ($featuredCompanies->take(8) as $company)
                                @include('front_web_template.common.company_bg-white overflow-hidden shadow rounded-lg')
                            @endforeach
                        </div>
                        <div class="flex flex-wrap justify-center">
                            <div class="flex-1 -12 text-center">
                            ...
                            <div class="marquee">
                                <div class="flex flex-wrap justify-center">
                                    @foreach ($notices as $key => $notice)
                                        <div class="flex-1 -xl-10 flex-1 -11 relative mb-4">
                                            ...
                                            <span href="#"
                                                class="transition duration-150 ease-in-out flex-1">{{ \Carbon\Carbon::parse($notice->created_at)->translatedFormat('jS M, Y') }}</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
        ...
        @if (count($testimonials) > 0)
            <section class="testimonial-section overflow-hidden  {{ (count($notices) > 0) ? 'mb-100' : 'mt-80 mb-100' }}  {{ (count($latestJobs) > 0) ? 'mt-80 mb-100' : '' }}">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto fluid p-sm-0">
                    <div class="overflow-hidden pb-60">
                        <div class="section-heading text-center">
                                        ...
                                        <div class="bg-white shadow rounded -lg overflow-hidden img-top relative">
                                            ...
                                            <div class="overlay absolute">
                                                <a href="{{ route('front.', $post->id) }}"
                                                    class="transition duration-150 ease-in-out flex-1"> {{ __('web.post_menu.read_more') }} </a>
                                            </div>
                                        </div>
        ...
        <!-- start-about-section -->
        <section class="about-section py-60 bg-indigo-600 -600">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto">
                <div class="flex flex-wrap justify-between items-center">
                    <div class="flex-1 -sm-3 flex-1 -6 text-center mb-sm-0 mb-4">
                    ...
                    <div class="flex-1 -sm-3 flex-1 -6 text-center">
                        <div class="about-desc">
                            <h3 class="text-white count">
                                {{ $dataCounts['resumes'] }}
                            </h3>
                    ...
                    <section class="slider-test-section pricing-plans relative">
                        <div id="carouselExampleControlsabout" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                @php
                                    $isshoeinline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 = 1; }
                                @endphp
                                        ...
                                        <div class="flex flex-wrap flex justify-center">
                                            @foreach ($plans as $plan)
                                                <div class="pricing-packages-section- bg-white shadow rounded -lg overflow-hidden lg:w-4/12 px-2 flex-1 sm-6 px-xl-3">
                                                    <div class="pricing-plan- bg-white overflow-hidden shadow rounded-lg bg-white shadow rounded -lg overflow-hidden bg-gray-100 shadow-none">
                                                        <div class="bg-white shadow rounded -lg overflow-hidden body text-center p-0">
                                                            <div class="bg-white shadow rounded -lg overflow-hidden body-top py-30">
                                                                <p class="mb-2 text-indigo-600 -600 fs-18 fw-bold">
                            ...
                            @if ($isshoeinline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 == 1)
                            <button class="carousel-control-prev about-control-prev" type="button"
                                ...
                                <i class="icon fa-solid fa-arflex flex-wrap -mx-4-left text-indigo-600 -600"></i>
                            </button>
                            <button class="carousel-control-next about-control-next" type="button"
                                ...
                                <i class="icon fa-solid fa-arflex flex-wrap -mx-4-right text-indigo-600 -600"></i>
                            </button>
                            @endif
                        </div>
                    </section>
