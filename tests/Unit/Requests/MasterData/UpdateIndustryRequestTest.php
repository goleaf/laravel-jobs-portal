...
use Tests\TestCase;
use App\Http\Requests\MasterData\UpdateIndustryRequest;
use App\Models\User;
...
/**
 * Context7 Unit Test for UpdateIndustryRequest
 * Testing validation rules and authorization
 */
class UpdateIndustryRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new UpdateIndustryRequest();
