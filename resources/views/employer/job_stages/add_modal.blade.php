<div id="addJobStageModal" class="fixed inset-0 z-50 overflow-y-auto fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded -lg shadow-xl max-w-lg w-full">
            ...
            <div class="px-6 py-4">
                <div class="px-4 py-3 rounded-md border border border border-gray-300 -gray-300 -gray-300 mb-4 p-4 rounded -md mb-4 danger hide hidden" id="maritalStatusValidationErrorsBox"></div>
                <div class="flex flex-wrap">
                    <div class="flex-1 sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['id'=>'jobStageName','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','text-red-500','placeholder' => __('messages.job_tag.name')]) }}
                    </div>
                    <div class="flex-1 sm-12 mb-5">
