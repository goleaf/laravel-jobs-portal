...
class IndustriesMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for IndustriesMasterDataRequest', [
