...
/**
 * Enhanced Enhanced Form Request for JobApplication showApplyJobForm
...
class ShowJobApplicationRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for ShowJobApplicationRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'JobApplicationController',
            'method' => 'showApplyJobForm',
