<div class="flex-1 -sm-6 flex flex-column mb-md-10 mb-5">
...
<div class="form-group col-sm-12 md:w-full flex-1 -xl-6">
    ...
    <div class="form-group col-xl-6 md:w-full flex-1 -sm-12">
