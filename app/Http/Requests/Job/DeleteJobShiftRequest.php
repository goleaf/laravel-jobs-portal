...
/**
 * Universal Form Request for deleting JobShift
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class DeleteJobShiftRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('JobShift'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteJobShiftRequest', [
