            ...
            <div class="px-6 py-4">
                ...
                <div class="flex flex-wrap">
                    <div class="mb-4 flex-1 sm-12 mb-5">
                        {{ Form::label('pfCurrentPassword', __('messages.company.current_password').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
                    ...
                    <div class="mb-4 flex-1 sm-12 mb-5">
                        {{ Form::label('pfNewPassword', __('messages.company.new_password').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
                        <span class="required"></span>
                    ...
                    <div class="mb-4 flex-1 sm-12">
                        {{ Form::label('pfNewConfirmPassword', __('messages.company.confirm_password').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
                        <span class="required"></span>
