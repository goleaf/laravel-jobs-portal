...
class CareerLevelsMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for CareerLevelsMasterDataRequest', [
