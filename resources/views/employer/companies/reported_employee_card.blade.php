<div class="col-xl-4 flex-1 md-6 candidate- bg-white shadow rounded-lg overflow-hidden">
    <div class="hover-effect-employee relative mb-5 border-hover-primary employee-border">
        ...
        <div class="employee-action- px-4 py-2 rounded font-medium transition-colors">
            ...
            <a title="<?php echo __('messages.common.delete') ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 border-transparent text-sm font-medium rounded-md transition duration-150 ease-in-out bg-red-600 text-white hover:bg-red-700 action-btn delete- px-4 py-2 rounded font-medium transition-colors"
               data-id="{{ $reportedEmployee->id }}" href="#">
