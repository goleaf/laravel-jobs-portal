...
{{ --    <div class="px-4 py-3 rounded-md border border-gray-300 mb-4 p-4 rounded-md mb-4 danger  hide hidden" id="editValidationErrorsBox"></div>-- }}
    <div class="flex flex-wrap">
        <div class="flex-1 sm-12 mb-5">
            ...
            {{ Form::text('home_title', $cmsServices['home_title'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.cms_service.home_title')]) }}
        </div>
        <div class="flex-1 sm-12 mb-5">
            {{ Form::label('home_description', __('messages.cms_service.home_description').(':'),['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
            {{ Form::textarea('home_description',$cmsServices['home_description'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.cms_service.home_description')]) }}
        </div>
    </div>
