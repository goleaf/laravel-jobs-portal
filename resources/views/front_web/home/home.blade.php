...
<head>
    ...
    <title>{{ config('app.name', 'Job Portal') }} - Home</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <h1 class="text-xl font-bold text-gray-900">{{ config('app.name', 'Job Portal') }}</h1>
                    </div>
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Your gateway to career opportunities. Find the perfect job or discover talented candidates.
                    </p>
