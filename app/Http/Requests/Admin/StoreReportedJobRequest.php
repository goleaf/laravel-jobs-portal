...
/**
 * Universal Form Request for storing ReportedJob
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class StoreReportedJobRequest extends FormRequest
{
    /**
    ...
    protected function failedValidation(Validator $validator): void
    {
        ...
        logger()->warning('Validation failed for StoreReportedJobRequest', [
