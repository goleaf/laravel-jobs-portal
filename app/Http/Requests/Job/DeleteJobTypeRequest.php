...
/**
 * Universal Form Request for deleting JobType
 * Implements Laravel 12 best practices with Universal MCP patterns.
 */
class DeleteJobTypeRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('JobType'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteJobTypeRequest', [
