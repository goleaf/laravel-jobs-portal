...
/**
 * Universal Form Request for deleting PostCategory
...
class DeletePostCategoryRequest extends FormRequest
{
    ...
    {
        $resource = $this->route(strtolower('PostCategory'));
    ...
    {
        logger()->warning('Delete validation failed for DeletePostCategoryRequest', [
