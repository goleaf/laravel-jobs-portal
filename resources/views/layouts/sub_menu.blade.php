...
<li class="nav-item d-none d-xl-grid dropdown dropdown-hover">
    ...
    <ul class="horizontal-submenu dropdown-menu top-100">
        <li>
            <a class="dropdown-item {{ Request::is('admin/privacy-policy*') ? 'active' : '' }} {{ !Request::is('admin/noticeboards*','admin/faqs*','admin/inquires*','admin/notification-settings*','admin/privacy-policy*','admin/front-settings*','admin/email-template*','admin/settings*') ? 'd-none' : '' }}"
