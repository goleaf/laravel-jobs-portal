        ...
        <div class="container mx-auto px-4 mx-auto">
            ...
            <div class="collapse bg-white shadow-sm collapse" id="navbarNav">
                <ul class="bg-white shadow-sm nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium {{ Request::is("about-us') ? 'active' : '' }}" href="{{ route('about-us') }}">{{ __('nav.about') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium {{ Request::is("contact') ? 'active' : '' }}" href="{{ route('contact') }}">{{ __('nav.contact') }}</a>
                    </li>
                </ul>
                ...
                <ul class="bg-white shadow-sm nav">
                    ...
                    <li class="nav-item">
                        <a class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium inline-flex items-center px-4 py-2 border border-gray-300 border-transparent text-sm font-medium rounded-md transition duration-150 ease-in-out px-4 py-2 rounded font-medium transition-colors outline-light ms-2" href="{{ route('register') }}">{{ __('nav.register') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="flex-1 md-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('about-us') }}" class="text-light text-decoration-none">{{ __('nav.about') }}</a></li>
                    </ul>
                </div>
                <div class="flex-1 md-2">
