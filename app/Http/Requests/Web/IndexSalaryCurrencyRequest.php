...
class IndexSalaryCurrencyRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for IndexSalaryCurrencyRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'SalaryCurrencyController',
            'method' => 'index',
