...
class IndexSalaryPeriodRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for IndexSalaryPeriodRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'SalaryPeriodController',
            'method' => 'index',
