<div class="flex flex-wrap">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('national_id_card', isset($candidate) ? $candidate->national_id_card : null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'placeholder' => __('messages.candidate.national_id_card')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
                <div class="flex flex-wrap">
                    ...
                    <div class="md:w-8/12 flex-1 sm-12 mb-0 pt-1">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::textarea('address', isset($candidate) ? $candidate->address : null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm address-height','rows'=>'5', 'placeholder' => __('messages.candidate.address')]) }}
    </div>
