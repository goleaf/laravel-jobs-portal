...
<div class="aside-menu- container mx-auto px-4 mx-auto" id="sidebar">
    ...
    <form class="flex relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="relative w-full sidebar-search-box">
            <input class="w-full px-3 py-2 border border-gray-300 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500" type="text" placeholder={{ __('messages.common.search') }} id="menuSearch" aria-label="Search" name="search">
    ...
    <div class="sidebar-scrolling overflow-auto">
        <ul class="aside-menu-container__aside-menu flex space-x-1 flex-col">
