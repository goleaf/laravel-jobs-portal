...
/**
 * Universal Form Request for storing Testimonials
...
class StoreTestimonialsRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', testimonials::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:testimonialss,name'],
    ...
    {
        logger()->info('Store validation failed for StoreTestimonialsRequest', [
