...
/**
 * Universal Form Request for storing BrandingSlider
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class StoreBrandingSliderRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()?->can('create', brandingslider::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:brandingsliders,name'],
    ...
    {
        logger()->info('Store validation failed for StoreBrandingSliderRequest', [
