<div class="flex flex-wrap">
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('name', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.company.employer_name')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        {{ Form::label('email', __('messages.company.email').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
        <span class="required"></span>
        {{ Form::email('email', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required', 'placeholder' => __('messages.company.email')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('ceo', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.company.ceo_name')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('location', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required','placeholder' => __('messages.company.location')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('no_of_offices', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'placeholder' => __('messages.company.no_of_offices')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="flex justify-end">
        {{ Form::submit(__('messages.common.save'),['class' => 'rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 focus:outline-none transition-colors me-3', 'id' => 'btnSave']) }}
