...
{{ -- <div class="lg:w-4/12 px-2 flex-1 md-6 px-xl-3 mb-40">
    <div class="bg-white shadow rounded -lg overflow-hidden py-30">
        ...
        <div class="bg-white shadow rounded -lg overflow-hidden desc flex flex- flex-1 justify-between h-full mt-4">
            ...
            <div class="desc flex">
                <a href="{{ route('front.', $job->job_id) }}" class="border border-gray-300 bg-transparent"
    ...
    <div class="bg-white shadow rounded -lg overflow-hidden py-30">
        <div class="flex justify-between items-center">
            ...
            <div class="icon relative pe-0">
                @if ($job->activeFeatured)
                    <div
                        class="md:w-1/12 flex-1 -sm-1 flex-1 -8 justify-end bookmark-icon relative pe-0 float-end flex">
                        <i class="text-indigo-600 -600 fa-solid fa-bookmark"></i>
                    </div>
                @else
                    <div
                        class="md:w-1/12 flex-1 -sm-1 flex-1 -8 bookmark-icon justify-end relative pe-0 float-end flex text-gray">
                        <i class="fa-regular fa-bookmark"></i>
                    </div>
                @endif
            </div>
        ...
        <div class="bg-white shadow rounded -lg overflow-hidden desc flex flex- flex-1 justify-between h-full mt-4">
            ...
            <div class="desc flex">
                ...
                <p class="fs-14 text text-indigo-600 -600 mb-0">{{ $job->jobsSkill->count() }}+</p>
            </div>
        </div>
    </div>
</div>
