...
use Tests\TestCase;
use App\Http\Requests\MasterData\DeleteFunctionalAreaRequest;
use App\Models\User;
...
/**
 * Context7 Unit Test for DeleteFunctionalAreaRequest
 * Testing validation rules and authorization
 */
class DeleteFunctionalAreaRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new DeleteFunctionalAreaRequest();
