<div class="flex flex-wrap">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('name', isset($user)?$user->first_name:null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','text-red-500', 'placeholder' => __('messages.company.employer_name')]) }}
    </div>
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5 mobile-itel-width">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex flex-nowrap">
            {{ Form::select('industry_id', $data['industries'],isset($company)?$company->industry_id:null, ['id'=>'industryId','class' => 'form-select ','placeholder' => __('messages.company.select_industry'),'text-red-500']) }}
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('ownership_type_id', $data['ownerShipTypes'],  isset($company)?$company->ownership_type_id:null, ['id'=>'ownershipTypeId','class' => 'form-select ','placeholder' => __('messages.company.select_ownership_type'),'text-red-500']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex flex-nowrap select2-width-input-grp">
            {{ Form::select('country_id', $data['countries'], null, ['id'=>'countryId','class' => 'form-select ','placeholder' => __('messages.company.select_country'),'text-red-500']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap select2-width-input-grp">
            {{ Form::select('state_id', (isset($state) && $state!=null)?$state:[], null, ['id'=>'stateId','class' => 'form-select ','placeholder' => __('messages.company.select_state'),'text-red-500']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('city_id', (isset($cities) && $cities!=null) ?$cities:[], null, ['id'=>'cityId','class' => 'form-select ','placeholder' => __('messages.company.select_city'),'text-red-500']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('company_size_id', $data['companySize'], isset($company)?$company->company_size_id:null, ['id'=>'companySizeId','class' => 'form-select ','placeholder' => __('messages.company.select_employer_size'),'text-red-500']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
