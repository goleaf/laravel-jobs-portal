...
class CompanySizesMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for CompanySizesMasterDataRequest', [
