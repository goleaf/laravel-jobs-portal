...
/**
 * Universal Form Request for deleting RequiredDegreeLevel
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class DeleteRequiredDegreeLevelRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('RequiredDegreeLevel'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteRequiredDegreeLevelRequest', [
