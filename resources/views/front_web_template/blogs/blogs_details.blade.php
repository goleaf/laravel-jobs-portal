                ...
                <div class="flex flex-wrap items-center justify-center">
                    <div class="flex-1 lg-6 text-center mb-lg-0 mb-md-5 mb-sm-4">
                        <div class="hero-content">
                            <h1 class="text-gray-600 mb-2">@lang('web.blog_detail')</h1>
                ...
                <div class="flex flex-wrap justify-center">
                    <div class="flex-1 lg-8">
                        <div class="blog-detail py-60">
                            ...
                            @role('Candidate')
                                <div class="designer-details flex flex-wrap pb-3">
                                    <a href="{{ $url['facebook'] }}" title="@lang('web.web_jobs.facebook')" target="_blank"
                                        class="flex me-2">
                                        <div class="inline-flex items-center px-2.5 py-0.5 rounded -full text-xs font-medium bg-indigo-600 -600 py-1 px-2">
                            ...
                            @if (count($assignCategories) > 0)
                                <div class="designer-details flex flex-wrap mb-3">
                                    @forelse($assignCategories as $categoryBadges)
                                        <span
                                            class="p-2 m-1 inline-flex items-center px-2.5 py-0.5 rounded -full text-xs font-medium bg-{{ getJobOtherColor($loop->index) }}">{{ $categoryBadges }}</span>
                                    @empty
                            ...
                            <div class="designer-details flex justify-between">
                                <div class="prev-post mb-2">
                                    @if ($prevPost)
                                        <div class="bg-white shadow rounded -lg overflow-hidden p-3">
                                            <a href="{{ route('front.', $prevPost->id) }}"
                                ...
                                <div class="next-post mb-2">
                                    @if ($nextPost)
                                        <div class="bg-white shadow rounded -lg overflow-hidden p-3">
                                            <a href="{{ route('front.', $nextPost->id) }}"
                                                class="text-gray primary-link-hover">
                        ...
                        <div class="comments py-60">
                            <h5 class="comment-lable fs-4 mb-3 text-gray-600 @if (count($comments) == 0) hidden @endif">@lang('web.web_blog.comments') <span class="comment-count"
                                    id="post-comment">({{ count($comments) }})</span></h5>
                            <div class="flex flex-wrap comment-box">
                                @foreach ($comments as $commentRecord)
                                    <div class="comment-bg-white shadow-sm rounded-lg bg-white shadow rounded -lg overflow-hidden py-20 {{ $loop->last ?"' : 'mb-40' }}">
                                            ...
                                            <div class="flex items-center me-2">
                                                ...
                                                <div class="">
                                                    <div class="bg-white shadow rounded -lg overflow-hidden body p-0">
                                                        <h5 class="bg-white shadow rounded -lg overflow-hidden title w-full fs-16 text-gray-600 text-break">
                                                            {{ $commentRecord->name }}
                                                        </h5>
                                                ...
                                                @if ($commentRecord->user_id == getLoggedInUserId() && getLoggedInUser())
                                                    <div class="inline -flex ms-2">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            class="edit-comment-inline-flex items-center px-4 py-2 rounded font-medium transition-colors"
                                                            data-id="{{ $commentRecord->id }}">
                                                            <div class="inline-flex items-center px-2.5 py-0.5 rounded -full text-xs font-medium text-indigo-600-600 py-2 ms-1"
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            class="action-inline-flex items-center px-4 py-2 rounded font-medium transition-colors float-right"
                                                            data-id="{{ $commentRecord->id }}">
                                                            <div class="inline-flex items-center px-2.5 py-0.5 rounded -full text-xs font-medium text-red-600 py-2 ms-1"
                                ...
                                @if (!Auth::check())
                                    <div class="flex-1 md-6">
                                        <div class="mb-4 mb-md-4 mb-3">
                                            <label for="" class="fs-16 text-gray-600 mb-3">{{ __('web.your_name') }}</label>
                                            <span class="text-red-600">*</span></label>
                                            <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray bg-white br-10 p-3 comment-name"
                                                name="name" placeholder="{{ __('web.web_blog.your_name') }}">
                                        </div>
                                    </div>
                                    <div class="flex-1 md-6">
                                        <div class="mb-4 mb-md-4 mb-3">
                                            <label for="" class="fs-16 text-gray-600 mb-3">{{ __('web.your_email') }}</label>
                                            <span class="text-red-600">*</span></label>
                                            <input type="email" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray bg-white br-10 p-3 comment-email"
                                ...
                                <div class="flex-1 md-12">
                                    <div class="mb-4">
                                        <label for="" class="fs-16 text-gray-600 mb-2">{{ __('web.your_comment') }}</label>
                                         <span class="text-red-600">*</span></label>
                                        <textarea id="comment-field" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10 comment"
