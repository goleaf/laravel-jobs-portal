<div class="flex flex-wrap">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ --        {{ Form::textarea('description', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm' , 'id' => 'details', 'rows' => '5']) }}--}}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    {{ --    <div class="form-group col-xl-3 md:w-3/12 flex-1 sm-12 mb-5">-- }}
...
{{ --    </div>-- }}
    ...
    <div class="flex justify-end">
        ...
        {{ Form::button(__('messages.common.save'), ['type' => 'submit','class' => 'rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 focus:outline-none transition-colors me-3','id' => 'editJobsSaveBtn','data-loading-text' =>"<span class="spinner-border spinner-border-sm"></span>".__('messages.common.process')]) }}
