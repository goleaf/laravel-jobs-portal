...
/**
 * Universal Form Request for storing JobCategory
...
class StoreJobCategoryRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', jobcategory::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:jobcategorys,name'],
    ...
    {
        logger()->info('Store validation failed for StoreJobCategoryRequest', [
