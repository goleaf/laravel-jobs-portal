...
/**
 * Universal Form Request for storing PostCategory
...
class StorePostCategoryRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', postcategory::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:postcategorys,name'],
    ...
    {
        logger()->info('Store validation failed for StorePostCategoryRequest', [
