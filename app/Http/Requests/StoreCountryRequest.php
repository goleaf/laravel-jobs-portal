...
/**
 * Universal Form Request for storing Country
...
class StoreCountryRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:countrys,name'],
    ...
    {
        logger()->info('Store validation failed for StoreCountryRequest', [
