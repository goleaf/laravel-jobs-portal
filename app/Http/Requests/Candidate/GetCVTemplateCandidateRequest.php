...
class GetCVTemplateCandidateRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for GetCVTemplateCandidateRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'CandidateController',
            'method' => 'getCVTemplate',
