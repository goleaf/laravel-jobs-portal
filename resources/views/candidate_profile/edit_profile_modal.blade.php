<div class="fixed inset-0 z-50 overflow-y-auto fade" id="editProfileModal"  tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 fixed inset-0 z-50 overflow-y-auto -lg">
        ...
        <div class="bg-white rounded -lg shadow-xl max-w-lg w-full">
            ...
            <div class="px-6 py-4">
                <div class="px-4 py-3 rounded-md border border border border-gray-300 -gray-300 -gray-300 mb-4 p-4 rounded -md mb-4 danger hidden" id="validationErrorsBoxCandidate"></div>
            ...
            @formOpen(['id'=>'changeCandidateLanguageForm'])
                <div class="px-6 py-4">
                    ...
                    <div class="">
                        ...
                        {{ Form::select('language', getUserLanguages(), getLoggedInUser()->language, ['id'=>'language','class' => 'form-select','text-red-500']) }}
                    </div>
                </div>
                <div class="px-6 py-4 border-t border border border-gray-300 -gray-300 -gray-200 flex justify-end space-x-2 pt-0">
