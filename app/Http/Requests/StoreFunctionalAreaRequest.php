...
/**
 * Universal Form Request for storing FunctionalArea
...
class StoreFunctionalAreaRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', functionalarea::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:functionalareas,name'],
    ...
    {
        logger()->info('Store validation failed for StoreFunctionalAreaRequest', [
