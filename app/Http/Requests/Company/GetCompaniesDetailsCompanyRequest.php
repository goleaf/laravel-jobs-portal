...
/**
 * Enhanced Enhanced Form Request for Company getCompaniesDetails
 * Implements Laravel 12 best practices with Enhanced MCP patterns
 * Auto-generated for Level 4 Complex System Transformation.
 */
class GetCompaniesDetailsCompanyRequest extends FormRequest
{
    /**
    ...
    {
        logger()->warning('Enhanced validation failed for GetCompaniesDetailsCompanyRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'CompanyController',
            'method' => 'getCompaniesDetails',
