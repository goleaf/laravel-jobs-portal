...
/**
 * Class JobTypeIndexRequest
 * Enterprise-grade validation for API Job Type index operations
 */
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => [
                'sometimes',
                'string',
                'in:name,created_at,updated_at,jobs_count,popularity',
            ],
            'sort_direction' => [
                'sometimes',
                'string',
            ...
            'include.*' => [
                'string',
                'in:jobs,statistics,meta,translations',
            ],
            'locale' => [
                'sometimes',
                'string',
