...
{{-- <p class="text text-indigo-600 -600 fs-14 mb-0 me-3">{{$skills->name }}</p> --}}
{{-- @if(count($job->jobsSkill) -1 > 0) --}}
{{-- <p class="fs-14 text text-indigo-600 -600 mb-0"> --}}
...
<div class="flex-1 -12 px-xl-3 mb-20">
    <div class="bg-white shadow rounded -lg overflow-hidden border border-gray-300 -l-color" style="padding:18px">
        <div class="flex flex-wrap flex">
            ...
            <div class="lg:w-8/12 px-2 md:w-9/12 flex-1 -9 d-sm-inline p-0">
                <div class="bg-white shadow rounded -lg overflow-hidden body">
                    ...
                    {{-- <a href="{{ route('front.',$job->job_id) }}" class="text-gray-600 primary-link-hover"> --}}
                    {{-- <h5 class="bg-white shadow rounded -lg overflow-hidden title fs-18 mb-0"> --}}
                    {{-- {{ html_entity_decode($job->job_title) }} --}}
                    {{-- </h5> --}}
                    {{-- </a> --}}
            ...
            <div class="lg:w-2/12 px-2 md:w-9/12 flex-1 -9 d-sm-inline me-5 absolute top-50 end-0 translate-middle-y">
                <div class="text-end justify-end float-end flex align-top">
                    <a href="{{ route('front.',$job->job_id) }}"
                    class="border border-gray-300 bg-transparent" style="padding:5px 15px !important;">{{ __('messages.view_details') }}</a>
                </div>
            </div>
            <div class="absolute top-0 end-0 mt-3">
                @if($job->activeFeatured)
                    <div class="md:w-1/12 flex-1 -sm-1 flex-1 -8 justify-end bookmark-icon relative pe-0 float-end flex">
                        <i class="text-indigo-600 -600 fa-solid fa-bookmark"></i>
                    </div>
                @else
                    <div class="md:w-1/12 flex-1 -sm-1 flex-1 -8 bookmark-icon justify-end relative pe-0 float-end flex text-gray">
