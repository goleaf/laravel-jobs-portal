...
use Tests\TestCase;
use App\Http\Requests\MasterData\DeleteCompanySizeRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for DeleteCompanySizeRequest
 * Testing validation rules and authorization
 */
class DeleteCompanySizeRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new DeleteCompanySizeRequest();
