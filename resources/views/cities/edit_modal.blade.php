    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded -lg shadow-xl max-w-lg w-full">
            <div class="px-6 py-4 border-b border border border-gray-300 -gray-300 -gray-200">
                <h3 class="fixed inset-0 z-50 overflow-y-auto -title">{{ __('messages.city.edit_city') }}</h3>
            ...
            <div class="px-6 py-4">
                ...
                <div class="mb-5">
                    ...
                    <span class="required"></span>
                    {{ Form::select('state_id', $states, null, ['id'=>'editStateId','class' => 'form-select','text-red-500', 'placeholder' => __('messages.company.select_state')]) }}
                </div>
