...
/**
 * Context7 Enhanced Form Request for MasterData functionalAreas
 * Implements Laravel 12 best practices with Context7 MCP patterns
 * Auto-generated for Level 4 Complex System Transformation
 */
class FunctionalAreasMasterDataRequest extends FormRequest
{
    /**
    ...
    {
        logger()->warning('Context7 validation failed for FunctionalAreasMasterDataRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'MasterDataController',
            'method' => 'functionalAreas',
