...
/**
 * Universal API Request for storing Candidate
 * Implements Laravel 12 API best practices with Universal MCP patterns
 */
class StoreCandidateApiRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()?->tokenCan(strtolower('Candidate') . ':create') ?? false;
    }
