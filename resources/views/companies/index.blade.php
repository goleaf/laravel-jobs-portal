                        ...
                        <form method="GET" action="{{ route('companies.index') }}">
                            <div class="flex flex-wrap">
                                <div class="flex-1 md-4">
                                    <input type="text" name="search" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="{{ __('Company name...') }}" value="{{ request('search') }}">
                                </div>
                                ...
                                <div class="flex-1 md-3">
                                    <select name="industry" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500">
                        ...
                        <div class="bg-white shadow rounded -lg overflow-hidden">
                            <div class="bg-white shadow rounded -lg overflow-hidden body">
                                <div class="flex items-center mb-3">
                                    <div class="bg-indigo-600 -600 rounded p-3 me-3">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded -full text-xs font-medium bg-blue-500">{{ rand(10, 100) }} {{ __('Open Jobs') }}</span>
                                    <small class="text-gray-500">{{ __('New York, NY') }}</small>
                                </div>
                                <div class="mt-3">
                                    <a href="{{ route('company.show', $i) }}" class="border border-gray-300 bg-transparent">{{ __('View Company') }}</a>
                                    <button class="border border-gray-300 bg-transparent">{{ __('Follow') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
