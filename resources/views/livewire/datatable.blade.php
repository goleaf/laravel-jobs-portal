        ...
        <div class="w-full md:w-1/3">
            <div class="relative">
                ...
                <input
                    ...
                    class="bg-gray-50 border border-gray-300 border-gray-300 text-gray-900 text-sm rounded -lg focus:ring-blue-500 focus: border border border-gray-300 -gray-300 -blue-500 block w-full pl-10 p-2 .5"
        ...
        <div class="flex flex- flex-1 md:flex- flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            @if(count($filters) > 0)
                <div class="relative w-full md:w-auto" x-data="{ open: false }">
                    <button 
                        @click="open = !open" 
                        class="flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-blue-500 w-full md:w-auto"
                    >
                    ...
                    >
                        <div class="p-3">
                            <div class="flex justify-between items-center pb-2 border border border-gray-300 -gray-300 -b">
            ...
            <div class="flex items-center w-full md:w-auto">
                ...
                <select
                    ...
                    class="bg-gray-50 border border-gray-300 border-gray-300 text-gray-900 text-sm rounded -lg focus:ring-blue-500 focus: border border border-gray-300 -gray-300 -blue-500 p-2"
                >
