    ...
    <section class="py-16 bg-white dark:bg-gray-800 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1 md:order-2">
                <img src="/images/mission-image.jpg" alt="Our Mission" class="rounded-xl shadow-lg w-full h-80 object-cover">
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="flex flex-col items-center">
                    <img class="h-32 w-32 rounded-full object-cover mb-4 shadow-md" src="/images/team-member-1.jpg" alt="Team Member">
                ...
                <!-- Team Member 2 -->
                <div class="flex flex-col items-center">
                    <img class="h-32 w-32 rounded-full object-cover mb-4 shadow-md" src="/images/team-member-2.jpg" alt="Team Member">
                ...
                <!-- Team Member 3 -->
                <div class="flex flex-col items-center">
                    <img class="h-32 w-32 rounded-full object-cover mb-4 shadow-md" src="/images/team-member-3.jpg" alt="Team Member">
                ...
                <!-- Team Member 4 -->
                <div class="flex flex-col items-center">
                    <img class="h-32 w-32 rounded-full object-cover mb-4 shadow-md" src="/images/team-member-4.jpg" alt="Team Member">
