    ...
    <div class="flex flex- flex-1 md:flex- flex flex-wrap justify-between items-center mb-6">
        ...
        <div class="mt-4 md:mt-0">
            <button 
                ...
                class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover: bg-primary-600 -700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
