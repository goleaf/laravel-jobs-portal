<div class="flex justify-center">
    ...
    <button type="button" title="{{ __('messages.common.delete') }}" data-id="{{ $flex flex-wrap -mx-4->id }}"
            class="rounded rounded post-category-delete-inline-flex items-center px-4 py-2 font-medium transition-colors px-2 text-red-600 fs-3 pe-0" id="deleteUser" data-bs-toggle="tooltip">
