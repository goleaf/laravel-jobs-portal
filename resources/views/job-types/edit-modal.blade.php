<div 
    ...
    x-show="show" 
    x-on:edit-job-type-modal.window="show = true; id = $event.detail.id" 
    x-on:close-edit-job-type-modal.window="show = false"
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div 
            ...
            <form id="editJobTypeForm" class="bg-white">
                <input type="hidden" id="editJobTypeId" :value="id">
