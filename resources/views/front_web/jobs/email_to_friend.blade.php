            ...
            <form name="frm" id="emailJobToFriend">
                <div class="px-6 py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" name="job_url" id="jobUrl" readonly>
                    </div>

                    <div class="mb-4">
                        <label class="fs-16 text-gray-600 mb-2" for="friendName">{{ __('messages.job.friend_name') }}</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" name="friend_name" id="friendName" required>
                    </div>

                    <div class="mb-4 mb-0">
                        <label class="fs-16 text-gray-600 mb-2" for="friendEmail">{{ __('messages.job.friend_email') }}</label>
                        <input type="email" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" name="friend_email" id="friendEmail" required>
                    </div>
                </div>
