...
class EditCandidateProfileRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for EditCandidateProfileRequest', [
