...
/**
 * Universal Form Request for storing SalaryPeriod
...
class StoreSalaryPeriodRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', salaryperiod::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:salaryperiods,name'],
    ...
    {
        logger()->info('Store validation failed for StoreSalaryPeriodRequest', [
