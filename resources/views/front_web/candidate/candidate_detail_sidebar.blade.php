{{-- <div class="mt-4 job-desc-right br-10 px-40 bg-gray mb-40 mt-lg-0 mt-md-5"> --}}
{{-- <div class="mb-2 desc-box flex justify-between"> --}}
{{-- <div class="mb-3 flex items-center"> --}}
{{-- <i class="text-indigo-600 fa-solid fa-calendar-days -600 me-2 fs-18"></i> --}}
{{-- <p class="mb-0 fs-14 text-gray-600"> --}}
...
{{-- <div class="mb-2 desc-box flex justify-between"> --}}
{{-- <div class="mb-3 flex items-center"> --}}
{{-- <i class="text-indigo-600 fa-solid fa-clock -600 me-2 fs-18"></i> --}}
{{-- <p class="mb-0 fs-14 text-gray-600"> --}}
...
{{-- <div class="mb-2 desc-box flex justify-between"> --}}
{{-- <div class="mb-3 flex items-center"> --}}
{{-- <i class="text-indigo-600 fa-solid fa-location-dot -600 me-2 fs-18"></i> --}}
{{-- <p class="mb-0 fs-14 text-gray-600">{{__('messages.candidate.current_salary') }}:</p> --}}
{{-- </div> --}}
{{-- <p class="fs-14 text-gray text-end"> --}}
...
{{-- <div class="mb-2 desc-box flex justify-between"> --}}
{{-- <div class="mb-3 flex items-center"> --}}
{{-- <i class="text-indigo-600 fa-solid fa-briefcase -600 me-2 fs-18"></i> --}}
{{-- <p class="mb-0 fs-14 text-gray-600"> <i class="icon icon-salary"></i>{{__('messages.candidate.expected_salary') }}:</p> --}}
{{-- </div> --}}
{{-- <p class="fs-14 text-gray text-end"> --}}
...
{{-- <div class="mb-3 flex items-center"> --}}
{{-- <i class="text-indigo-600 fa-solid fa-briefcase -600 me-2 fs-18"></i> --}}
{{-- <p class="mb-0 fs-14 text-gray-600"> <i class="icon icon-salary"></i><i class="icon icon-user-2"></i>{{__('messages.candidate.gender') }}:</p> --}}
{{-- </div> --}}
{{-- <p class="fs-14 text-gray text-end"> --}}
    ...
    <div class="flex-1 -12 mb-40">
        <div class="overflow-hidden shadow rounded-lg rounded bg-white overflow-hidden shadow bg-white job- -lg py-30">
            <div class="flex-wrap flex flex justify-content-lg-between">
                <div class="mt-3 flex-1 -5">
                    <i class="text-indigo-600 fa-solid fa-calendar-days -600 fs-4"></i>
                    <p class="overflow-hidden shadow rounded mb-0 bg-white details-page- -lg text" >
                        {{ __('messages.candidate_profile.education') }}</p>
                ...
                @if($candidateDetails->$user->dob)
                    <div class="mt-3 flex-1 -5">
                        <i class="text-indigo-600 fa-solid fa-cake-candles -600 fs-4"></i>
                        <p class="overflow-hidden shadow rounded mb-0 bg-white details-page- -lg text" >
                ...
                @endif
                <div class="mt-3 flex-1 -5">
                    <i class="text-indigo-600 fa-solid fa-wallet -600 fs-4"></i>
                    <p class="overflow-hidden shadow rounded mb-0 bg-white details-page- -lg text" >
                ...
                <div class="mt-3 flex-1 -5">
                    <i class="text-indigo-600 fa-solid fa-venus -600 fs-4"></i>
                    <p class="overflow-hidden shadow rounded mb-0 bg-white details-page- -lg text" >
