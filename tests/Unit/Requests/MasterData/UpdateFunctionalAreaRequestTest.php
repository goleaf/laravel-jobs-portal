...
use Tests\TestCase;
use App\Http\Requests\MasterData\UpdateFunctionalAreaRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for UpdateFunctionalAreaRequest
 * Testing validation rules and authorization
 */
class UpdateFunctionalAreaRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new UpdateFunctionalAreaRequest();
