<footer class="footer bg-gradient">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto px-4 mx-auto">
        <div class="flex flex-wrap justify-between">
            <div class="flex-1 -xxl-3 flex-1 -xl-4 flex-1 lg-6 mb-xl-0 mb-5">
                ...
                @formOpen(['id' => 'newsLetterForm'])
                    <div class="email flex">
                        ...
                        <div class="icon flex justify-center items-center bg-indigo-600 -600">
            ...
            <div class="flex-1 -xl-2 lg:w-6/12 px-2 flex-1 md-6 mb-3">
            ...
            <div class="flex-1 -12 text-center mt-lg-5 mt-4 copy-right">
                <p class="pt-4 pb-4 text-gray fs-13">
                    &copy;{{ date('Y') }}
                    <a href="{{ getSettingValue('company_url') }}" class="text-indigo-600 -600">
