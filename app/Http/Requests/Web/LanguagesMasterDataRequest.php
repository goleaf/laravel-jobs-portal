...
class LanguagesMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for LanguagesMasterDataRequest', [
