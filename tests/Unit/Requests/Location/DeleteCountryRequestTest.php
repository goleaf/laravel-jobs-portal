...
use Tests\TestCase;
use App\Http\Requests\Location\DeleteCountryRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for DeleteCountryRequest
 * Testing validation rules and authorization
 */
class DeleteCountryRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new DeleteCountryRequest();
