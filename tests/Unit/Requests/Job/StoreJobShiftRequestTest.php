...
use App\Http\Requests\Job\StoreJobShiftRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for StoreJobShiftRequest
 ...
 * @coversNothing
 */
class StoreJobShiftRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreJobShiftRequest();
