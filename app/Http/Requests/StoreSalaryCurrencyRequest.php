...
/**
 * Universal Form Request for storing SalaryCurrency
...
class StoreSalaryCurrencyRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', salarycurrency::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:salarycurrencys,name'],
    ...
    {
        logger()->info('Store validation failed for StoreSalaryCurrencyRequest', [
