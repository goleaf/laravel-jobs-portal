...
class IndexBrandingSliderRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for IndexBrandingSliderRequest', [
