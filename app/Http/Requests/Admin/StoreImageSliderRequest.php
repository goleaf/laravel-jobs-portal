...
/**
 * Universal Form Request for storing ImageSlider
...
class StoreImageSliderRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', imageslider::class) ?? true;
    }
    ...
    {
        logger()->info('Store validation failed for StoreImageSliderRequest', [
