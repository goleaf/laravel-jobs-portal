...
/**
 * Universal Form Request for deleting SalaryPeriod
 * Implements Laravel 12 best practices with Universal MCP patterns.
 */
class DeleteSalaryPeriodRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('SalaryPeriod'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteSalaryPeriodRequest', [
