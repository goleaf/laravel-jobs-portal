<div class="flex flex-wrap">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('name', isset($user)?$user->first_name:null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.company.employer_name')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5 mobile-itel-width">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('ceo', (isset($company) ? $company->ceo: null), ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.company.ceo_name')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap select2-width-input-grp">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap select2-width-input-grp">
            {{ Form::select('state_id', (isset($state) && $state!=null)?$state:[], null, ['id'=>'stateId','class' => 'form-select ','placeholder' => __('messages.company.select_state'),'required']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded-l-md text-gray-500 border-0">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('city_id', (isset($cities) && $cities!=null) ?$cities:[], null, ['id'=>'cityId','class' => 'form-select ','placeholder' => __('messages.company.select_city'),'required']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded-l-md text-gray-500 border-0">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('no_of_offices', (isset($company) ? $company->no_of_offices: null), ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required', 'placeholder' => __('messages.company.no_of_offices'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex items-center form-switch mb-3">
            <input class="flex items-center input isActive" name="is_active" type="checkbox"
                   data-id="{{ $company->id }}"
