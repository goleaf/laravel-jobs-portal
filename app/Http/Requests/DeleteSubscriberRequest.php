...
/**
 * Universal Form Request for deleting Subscriber
...
class DeleteSubscriberRequest extends FormRequest
{
    ...
    {
        $resource = $this->route(strtolower('Subscriber'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteSubscriberRequest', [
