...
use App\Filament\Resources\RequiredDegreeLevelResource\Pages;
...
class RequiredDegreeLevelResource extends Resource
{
    protected static ?string $model = RequiredDegreeLevel::class;
            ...
            ->schema([
                Forms\Components\Section::make()
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('level_order')->label(__('Level Order'))->numeric()->required(),
                        Forms\Components\TextInput::make('years_required')->label(__('Years Required'))->numeric()->minValue(0),
                        ...
                        Forms\Components\TextInput::make('certification_required')->label(__('Certification Required'))->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('level_order')->label(__('Order'))->numeric()->sortable(),
                Tables\Columns\TextColumn::make('years_required')->label(__('Years'))->numeric()->sortable()->toggleable(),
    ...
    {
        return [
            'index' => Pages\ListRequiredDegreeLevels::route('/'),
            'create' => Pages\CreateRequiredDegreeLevel::route('/create'),
            'view' => Pages\ViewRequiredDegreeLevel::route('/{record}'),
            'edit' => Pages\EditRequiredDegreeLevel::route('/{record}/edit'),
        ];
    }
}
