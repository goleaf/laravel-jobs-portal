...
class UpdateCompanySizeRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('update', $this->route('companySize'));
    }
    ...
    {
        $companySizeId = $this->route('companySize')->id ?? $this->route('id');
    ...
    {
        // Log update attempt for security
        \Log::info('Company size update attempted', [
            'user_id' => $this->user()->id,
            'company_size_id' => $this->route('companySize')->id ?? $this->route('id'),
