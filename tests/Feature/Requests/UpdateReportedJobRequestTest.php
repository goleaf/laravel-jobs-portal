...
/**
 * Context7 Enhanced Validation Tests for UpdateReportedJobRequest
 * 
 * @group validation
 * @group requests
 */
class UpdateReportedJobRequestTest extends TestCase
{
    ...
    /** @test */
    public function test_ReportedJob_validation()
    {
        $request = new UpdateReportedJobRequest();
        $rules = $request->rules();
    ...
    /** @test */
    public function test_ReportedJobs_validation()
    {
        $request = new UpdateReportedJobRequest();
        $rules = $request->rules();
