...
class DeleteCandidateApiRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for DeleteCandidateApiRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'CandidateApiController',
            'method' => 'destroy',
