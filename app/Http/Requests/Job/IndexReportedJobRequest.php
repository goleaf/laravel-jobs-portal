...
class IndexReportedJobRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for IndexReportedJobRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'ReportedJobController',
            'method' => 'index',
