...
/**
 * Universal Form Request for deleting CareerLevel
 * Implements Laravel 12 best practices with Universal MCP patterns.
 */
class DeleteCareerLevelRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('CareerLevel'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteCareerLevelRequest', [
