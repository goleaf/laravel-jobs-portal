    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content resumes-width">
            ...
            <div class="modal-footer">
                <button type="button" class="btn px-4 py-2 rounded font-medium transition-colors -primary me-3 printCV">{{ __('messages.common.print') }}</button>
                <button class="btn px-4 py-2 rounded font-medium transition-colors -primary me-3"
                        id="downloadPDF">{{ __('messages.common.download').' '.__('messages.pdf') }}</button>
                <button type="button" class="btn px-4 py-2 rounded font-medium transition-colors -secondary me-2"
