...
/**
 * Context7 Enhanced Validation Tests for UpdateOwnershipTypeRequest
 * 
 * @group validation
 * @group requests
 */
class UpdateOwnershipTypeRequestTest extends TestCase
{
    ...
    /** @test */
    public function test_OwnershipType_validation()
    {
        $request = new UpdateOwnershipTypeRequest();
        $rules = $request->rules();
    ...
    /** @test */
    public function test_OwnershipTypes_validation()
    {
        $request = new UpdateOwnershipTypeRequest();
        $rules = $request->rules();
