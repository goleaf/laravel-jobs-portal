...
class RegisterController extends AppBaseController
{
    ...
    public function candidateRegister(): View
    {
        ...
        return view('front_web_template.auth.candidate_register', compact('isGoogleReCaptchaEnabled'));
    }
    ...
    public function employerRegister(): View
    {
        ...
        return view('front_web_template.auth.employer_register', compact('isGoogleReCaptchaEnabled'));
    }
