...
/**
 * Universal Form Request for deleting Noticeboard
...
class DeleteNoticeboardRequest extends FormRequest
{
    ...
    {
        $resource = $this->route(strtolower('Noticeboard'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteNoticeboardRequest', [
