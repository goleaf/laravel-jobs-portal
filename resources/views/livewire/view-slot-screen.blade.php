            ...
            <div class="slot-box-inner mb-3">
                    ...
                    @if($jobApplication->job_stage_id==$jobSchedule[0]->stage_id)
                        ...
                        <div class="flex items-center me-4 me-md-5 form- px-4 py-2 rounded font-medium transition-colors float-right">
                            <a href="javascript:void(0)"
                               class="border border-gray-300 bg-transparent" data-batch="{{ $batch }}">
                ...
                @foreach($jobSchedule as $key => $value)
                    <div
                        ...
                        <input type="hidden"
                               class="{{ $value->status == \App\Models\JobApplicationSchedule::STATUS_REJECTED ? 'slot- bg-red-600 ' : '' }}{{ $value->status == \App\Models\JobApplicationSchedule::STATUS_SEND ? 'slot- bg-green-600 ' : '' }}"
                               value="{{ $value->id }}">
                        <div
                            ...
                            <div class="flex-1 sm-5 mb-3">
                                <div class="">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" name=""
                            ...
                            <div class="flex-1 sm-6 mt-0">
                                ...
                                <textarea class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 textarea-sizing" name=""
                    ...
                    <div
                        ...
                        <textarea name="choose_slot_notes" class="textarea-sizing w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500"
                                  readonly
                        ...
                        @if($isLastRecordStage == $value->stage_id)
                            ...
                            <textarea name="cancel_slot_notes"
                                      class="textarea-sizing w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 cancel-slot-notes" required
                ...
                @if($candidateRejectedSlot > 0)
                    <div class="flex flex-wrap shadow-sm py-5 choose-slot-textarea
                        ...
                        <div class="flex-1 sm-12 flex flex- flex-1">
