...
/**
 * Universal Form Request for deleting Testimonials
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class DeleteTestimonialsRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('Testimonials'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteTestimonialsRequest', [
