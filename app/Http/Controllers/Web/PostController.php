...
class PostController extends AppBaseController
{
    ...
    public function getBlogLists(): View
    {
        ...
        return view('front_web_template.blogs.index')->with($data);
    }
    ...
    public function getBlogDetails(Post $post): View
    {
        ...
        return view('front_web_template.blogs.blogs_details', compact('url'))->with($data);
    }
    ...
    public function getBlogDetailsByCategory(PostCategory $postCategory): View
    {
        ...
        return view('front_web_template.blogs.blogs_based_on_category')->with($data);
    }
