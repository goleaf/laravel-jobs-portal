...
class HeaderSlidersCmsRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for HeaderSlidersCmsRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'CmsController',
            'method' => 'headerSliders',
