...
/**
 * Universal Form Request for deleting CompanySize
...
class DeleteCompanySizeRequest extends FormRequest
{
    ...
    {
        $resource = $this->route(strtolower('CompanySize'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteCompanySizeRequest', [
