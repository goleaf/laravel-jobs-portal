...
/**
 * Enhanced Enhanced Form Request for Register employerRegister
...
class RegisterRegisterRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for RegisterRegisterRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'RegisterController',
            'method' => 'employerRegister',
