                    ...
                    <div class="flex-1 sm-12 mb-5">
                        <div class="flex flex-wrap">
                            <div class="flex-1 sm-12 mb-5">
                                ...
                                {{ Form::text('title', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'id' => 'title', 'required', 'placeholder' =>  __('messages.candidate_profile.title')]) }}
                            </div>
