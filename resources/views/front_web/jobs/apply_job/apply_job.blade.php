    ...
    <div class="apply-job-page">
                        ...
                        <div class="hero-content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-center mb-0">
                                    ...
                                    <li class="breadcrumb-item text-indigo-600-600 fs-18" aria-current="page">@lang('web.job_details.apply_for_job')</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="apply-job-section contact-section py-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto">
                            ...
                            <div class="flex flex-wrap mb-3">
                                ...
                                <div class="flex-1 lg-10">
                                    <h2 class="ml-3 mb-2">{{ __('web.apply_for_job.apply_for') }}</h2> <span
                                        class="text-indigo-600 -600 ml-3">{{ $job->job_title }}</span>
                                </div>
                            </div>
                ...
                <div class="flex-1 -xl-8 flex-1 md-10 mx-auto">
                    <form id="applyJobForm" class="py-40 px-40 bg-gray">
                        ...
                        <div class="flex flex-wrap">
                            <div class="mb-4 lg:w-full px-2 md:w-full flex-1 sm-12">
                                <div class="response"></div>
                            </div>
                            <div class="lg:w-6/12 px-2 md:w-full flex-1 sm-12 mb-4 chosen-search">
                                <label class="fs-16 text-gray-600 mb-2" for="resumeId">{{ __('messages.apply_job.resume').':' }}<span
                                            class="text-red-600">*</span></label>
                                <select class="chosen-search-select w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500" data-live-search="true" data-size="5"
                            ...
                            <div class="lg:w-6/12 px-2 md:w-full flex-1 sm-12 mb-4">
                                ...
                                <input type="text" id="expected_salary" name="expected_salary" min="0" max="9999999999"
                                       ...
                                       class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 price-input" required>
                            </div>

                            <div class="lg:w-full px-2 md:w-full flex-1 sm-12 mb-4">
                                <label class="fs-16 text-gray-600 mb-2" for="notes">{{ __('messages.apply_job.notes').':' }}</label>
                                <textarea rows="5" id="notes" name="notes"
                                          class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500">{{ ($isJobDrafted) ? $draftJobDetails->notes : '' }}</textarea>
                            </div>
                            @if(getSettingValue('enable_google_recaptcha'))
                            <div class="lg:w-full px-2 md:w-full flex-1 sm-12 mb-4 mt10 text-center">
                            ...
                            @endif
                            <div class="lg:w-full px-2 md:w-full flex-1 sm-12 mb-4 text-center">
                                @if(!$isApplied)
                                    @if(!$isJobDrafted)
                                    ...
                                    @endif
                                @else
                                    <button class="border border-gray-300 bg-transparent">{{ __('web.apply_for_job.already_applied') }}</button>
                                @endif
                            </div>
                        </div>
                    </form>
...
@push('scripts')
    @vite('resources/js/pages/apply_job.js')
@endpush
