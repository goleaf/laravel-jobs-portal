                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="flex-1 md-12 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="w-full px-3 py-2 border border-gray-300 border border-gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" name="email"
                                               id="email"
                                ...
                                <div class="flex-1 md-12 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="password" name="password"
                                               class="w-full px-3 py-2 border border-gray-300 border border-gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" id="password"
                            ...
                            <div class="flex-1 -12">
                                <div class="flex items-center justify-between flex-wrap">
                                    ...
                                    <a href="{{ route('password.request') }}"
                                       class="text-indigo-600 -600">{{ __('web.login_menu.forget_password') }}</a>
                                </div>
                            </div>
                            <div class="flex-1 -12 d-grid my-4">
                                <button type="submit" class="border border-gray-300 bg-transparent" data-turbo="false">{{ __('web.login') }}</button>
                            </div>
                            @php
