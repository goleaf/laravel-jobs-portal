            ...
            <div class="px-6 py-4">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="flex-1 sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('degree_title', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required','id'=>'editDegreeTitle','placeholder'=>__('messages.candidate_profile.degree_title')]) }}
                    </div>
                    <div class="flex-1 sm-6 mb-5">
