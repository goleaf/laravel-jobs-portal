<div class="ps-xl-7 px-2 pe-xl-0 flex align-items-stretch">
    <ul class="horizontal-menu nav flex- flex flex-wrap block d-xl-flex">
        ...
        <li class="nav-item hidden d-xl-grid dropdown dropdown-hover {{ Request::is("employer/transactions*','employer/manage-subscription*') ? 'active' : '' }}">
