...
/**
 * Universal Form Request for storing BlogComment
...
class StoreBlogCommentRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', blogcomment::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:blogcomments,name'],
    ...
    {
        logger()->info('Store validation failed for StoreBlogCommentRequest', [
