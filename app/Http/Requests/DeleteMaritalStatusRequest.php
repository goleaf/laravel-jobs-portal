...
/**
 * Universal Form Request for deleting MaritalStatus
...
class DeleteMaritalStatusRequest extends FormRequest
{
    ...
    {
        $resource = $this->route(strtolower('MaritalStatus'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteMaritalStatusRequest', [
