...
/**
 * Universal Test for OwnershipTypeController
 ...
 * @coversNothing
 */
class OwnershipTypeControllerTest extends TestCase
{
    use RefreshDatabase;
    use WithFaker;
    ...
    public function test_store_creates_new_record(): void
    {
        ...
        // $this->assertDatabaseHas('ownershiptypes', ['name' => $data['name']]);
    }
    ...
    public function test_csrf_protection_is_enforced(): void
    {
        ...
        $response = $this->post(route('ownershiptype.store'), $data);
    ...
    public function test_handles_server_errors_gracefully(): void
    {
        ...
        $response = $this->actingAs($this->user)
            ->get(route('ownershiptype.show', 'invalid-id'));
