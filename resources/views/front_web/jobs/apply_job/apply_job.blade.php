                    ...
                    <form id="applyJobForm" class="py-40 px-40 bg-gray">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="lg:w-6/12 px-2 md:w-full flex-1 sm-12 form-group chosen-search">
                                ...
                                {{ --                            {{ Form::select('resume_id', $resumes, ($isJobDrafted) ? $draftJobDetails->resume_id : $default_resume, ['class' => 'selectpicker block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','id' => 'resumeId','placeholder'=>'Select Resume', 'required']) }}--}}
                            </div>
