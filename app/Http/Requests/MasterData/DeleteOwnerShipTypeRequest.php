...
/**
 * Universal Form Request for deleting OwnerShipType
 * Implements Laravel 12 best practices with Universal MCP patterns.
 */
class DeleteOwnerShipTypeRequest extends FormRequest
{
    /**
    ...
    {
        $resource = $this->route(strtolower('OwnerShipType'));
    ...
    {
        logger()->warning('Delete validation failed for DeleteOwnerShipTypeRequest', [
