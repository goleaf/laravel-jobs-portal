...
/**
 * Universal Form Request for storing CareerLevel
 * Implements Laravel 12 best practices with Universal MCP patterns
 */
class StoreCareerLevelRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()?->can('create', careerlevel::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:careerlevels,name'],
    ...
    {
        logger()->info('Store validation failed for StoreCareerLevelRequest', [
