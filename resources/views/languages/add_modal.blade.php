<div id="addLanguageModal" class="fixed inset-0 z-10 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-4">
                            <form id="addLanguageForm">
                                <div id="languageValidationErrorsBox" class="hidden p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg"></div>
                                ...
                                <div class="mb-4">
                                    <label for="languageIsoCode" class="block text-sm font-medium text-gray-700">
