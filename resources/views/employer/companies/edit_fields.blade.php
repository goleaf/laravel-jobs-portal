<div class="flex flex-wrap">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('name', isset($user)?$user->full_name:null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','required', 'placeholder' => __('messages.company.name')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mobile-itel-width mb-5">
