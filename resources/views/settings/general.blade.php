...
@section('section')
    ...
    <div class="flex flex-wrap mt-3">
        <div class="flex-1 sm-6">
            ...
            {{ Form::text('application_name', $setting['application_name'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required','placeholder'=>__('messages.setting.application_name')]) }}
        </div>
        <div class="flex-1 sm-6">
            {{ Form::label('application_name', __('messages.setting.company_url').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}
            <span class="required"></span>
            {{ Form::text('company_url', $setting['company_url'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required', 'id' => 'companyUrl','placeholder' => __('messages.setting.company_url')]) }}
        </div>
        <div class="flex-1 sm-12 my-0 mt-5">
            ...
            <span class="required"></span>
            {{ Form::textarea('company_description', $setting['company_description'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-75', 'required','placeholder' => __('messages.setting.company_description')]) }}
        </div>
    </div>
    <div class="flex flex-wrap">
        ...
        <div class="md:w-5/12 flex-1 sm-6 mb-5">
            {{ Form::label('status', __('messages.setting.enable_google_recaptcha'), ['class' => 'block text-sm font-medium text-gray-700 mb-1 d-inline']) }}
            <span class="required"></span>
