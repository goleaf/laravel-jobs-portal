        ...
        <div class="bg-white rounded -lg shadow-xl max-w-lg w-full">
            ...
            <div class="px-6 py-4">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::text('name', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','text-red-500', 'placeholder' => __('messages.job_category.name')]) }}
                </div>
                ...
                <div class="px-4-xl-6 md:w-6/12 flex-1 sm-12 mb-5" io-image-input="true">
        ...
        <i class="fas fa-question-circle ml-1 general-question-mark"></i>
                    ...
                    <div class="block">
                        <div class="image-picker">
                            ...
                            <span class="picker-edit rounded -full text-gray-500 fs-small" data-bs-toggle="tooltip"
