<div id="editBoardModal" class="fixed inset-0 z-50 overflow-y-auto fade" role="dialog" tabindex="-1" aria-hidden="true">
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-lg w-full">
            ...
            <div class="px-6 py-4">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::text('title', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm', 'required', 'id' => 'editTitle','placeholder' => __('messages.noticeboard.title')]) }}
                </div>
                <div class="mb-5">
