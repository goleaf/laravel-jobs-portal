...
/**
 * Context7 Optimized Base Controller
 * Implements MCP best practices for Laravel 12 performance and security
 */
abstract class Context7BaseController extends Controller
{
    ...
    /**
     * Context7 Pattern: Flexible caching with stale-while-revalidate
     *
    ...
    /**
     * Context7 Pattern: Standard cache with remember
     *
     * @param string $key Cache key
     * @param callable $callback Function to execute if not cached
    ...
    /**
     * Context7 Pattern: Optimized cursor pagination for large datasets
     *
    ...
    /**
     * Context7 Pattern: Standard pagination with caching
     *
     * @param Builder $query Query builder instance  
     * @param int $perPage Items per page
    ...
    /**
     * Context7 Pattern: Chunk processing for large datasets
     *
     * @param Builder $query Query builder instance
    ...
    /**
     * Context7 Pattern: Optimized query with eager loading
     *
     * @param Builder $query Query builder instance
    ...
    /**
     * Context7 Pattern: Safe transaction execution
     *
    ...
    /**
     * Context7 Pattern: Pessimistic locking for critical operations
     *
     * @param Builder $query Query builder instance
     * @return Builder
     */
    ...
    /**
     * Context7 Pattern: Shared locking for read operations
     *
     * @param Builder $query Query builder instance
     * @return Builder
     */
    ...
    /**
     * Context7 Pattern: Generate cache key with request parameters
     *
    ...
    /**
     * Context7 Pattern: Generate rate limit key
     *
     * @param Request $request Request instance
    ...
    /**
     * Context7 Pattern: JSON response with consistent format
     *
    ...
    /**
     * Context7 Pattern: Error response with consistent format
     *
    ...
    /**
     * Context7 Pattern: Cached model retrieval
     *
    ...
    /**
     * Context7 Pattern: Clear model cache
     *
     * @param string $model Model class name
     * @param mixed $id Model ID
     * @return void
