...
use Tests\TestCase;
use App\Http\Requests\Job\DeleteJobShiftRequest;
use App\Models\User;
...
/**
 * Context7 Unit Test for DeleteJobShiftRequest
 * Testing validation rules and authorization
 */
class DeleteJobShiftRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new DeleteJobShiftRequest();
