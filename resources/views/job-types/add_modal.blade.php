<div id="addJobTypeModal" class="fixed inset-0 z-10 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-4">
                            <form id="addJobTypeForm">
                                <div id="jobTypeValidationErrorsBox" class="hidden p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg"></div>
                                
                                <div class="mb-4">
                                    <label for="name" class="block text-sm font-medium text-gray-700">
                                        {{ __('messages.job_type.name') }}
                                ...
                                <div class="mb-4">
                                    <label for="description" class="block text-sm font-medium text-gray-700">
                                        {{ __('messages.job_type.description') }}
                                    </label>
                                    <textarea name="description" id="description" rows="3"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                                        placeholder="{{ __('messages.job_type.description') }}"></textarea>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" id="jobTypeBtnSave" 
                ...
                <button type="button" id="jobTypeBtnCancel"
