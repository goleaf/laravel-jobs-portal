...
class SubscriptionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('starts_at')->label(__('Starts'))->required(),
                Forms\Components\DatePicker::make('ends_at')->label(__('Ends')),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('plan.name')->label(__('Plan'))->searchable()->sortable(),
                Tables\Columns\TextColumn::make('company.name')->label(__('Company'))->toggleable(),
