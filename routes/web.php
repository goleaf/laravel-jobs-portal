...
Route::get('/states-list', [LocationController::class, 'getStates'])->name('states-list');
Route::get('/cities-list', [LocationController::class, 'getCities'])->name('cities-list');
Route::get('/countries-list', [LocationController::class, 'getCountries'])->name('countries-list');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/states', [MasterDataController::class, 'states'])->name('states.index');
        Route::get('/cities', [MasterDataController::class, 'cities'])->name('cities.index');
        Route::get('/marital-status', [MasterDataController::class, 'maritalStatus'])->name('maritalStatus.index');
        Route::get('/skills', [MasterDataController::class, 'skills'])->name('skills.index');
        Route::get('/salary-periods', [MasterDataController::class, 'salaryPeriods'])->name('salaryPeriod.index');
        Route::get('/industries', [MasterDataController::class, 'industries'])->name('industry.index');
        Route::get('/company-sizes', [MasterDataController::class, 'companySizes'])->name('companySize.index');
        ...
        Route::get('/functional-areas', [MasterDataController::class, 'functionalAreas'])->name('functionalArea.index');
        Route::get('/career-levels', [MasterDataController::class, 'careerLevels'])->name('careerLevel.index');
        Route::get('/salary-currencies', [MasterDataController::class, 'salaryCurrencies'])->name('salaryCurrency.index');
        Route::get('/ownership-types', [MasterDataController::class, 'ownershipTypes'])->name('ownerShipType.index');
        Route::get('/languages', [MasterDataController::class, 'languages'])->name('languages.index');
        ...
        Route::get('/testimonials', [CmsController::class, 'testimonials'])->name('testimonials.index');
        Route::get('/branding-sliders', [CmsController::class, 'brandingSliders'])->name('branding.sliders.index');
        Route::get('/header-sliders', [CmsController::class, 'headerSliders'])->name('header.sliders.index');
        Route::get('/image-sliders', [CmsController::class, 'imageSliders'])->name('image-sliders.index');
        Route::get('/cms-services', [CmsController::class, 'cmsServices'])->name('cms.services.web.index');
        Route::get('/cms-about-us', [CmsController::class, 'cmsAboutUs'])->name('cms.about-us.service');
...
Route::middleware(['auth'])->prefix('realtime')->name('realtime.')->group(function () {
    ...
    Route::post('/applications/{jobApplication}/status', [RealTimeController::class, 'updateApplicationStatus'])->name('applications.status');
});
...
Route::middleware(['auth'])->group(function () {
    Route::post('/blog/{blog}/comment', [BlogCommentController::class, 'store'])
...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/branding-sliders', [BrandingSliderController::class, 'index'])
        ->name('branding.sliders.index')
    ;

    Route::get('/header-sliders', [HeaderSliderController::class, 'index'])
    ...
    Route::get('/reported-jobs', [ReportedJobController::class, 'index'])
        ->name('reported.jobs')
    ;
    ...
    Route::get('/salary-currencies', [SalaryCurrencyController::class, 'index'])
        ->name('salaryCurrency.index')
    ;
...
Route::middleware(['auth'])->prefix('admin')->name('masterdata.')->group(function () {
    Route::get('/masterdata', [MasterDataController::class, 'index'])->name('index');
    Route::get('/masterdata/create', [MasterDataController::class, 'create'])->name('create');
    Route::post('/masterdata', [MasterDataController::class, 'store'])->name('store');
    Route::get('/masterdata/{id}', [MasterDataController::class, 'show'])->name('show');
    Route::get('/masterdata/{id}/edit', [MasterDataController::class, 'edit'])->name('edit');
    Route::put('/masterdata/{id}', [MasterDataController::class, 'update'])->name('update');
    Route::delete('/masterdata/{id}', [MasterDataController::class, 'destroy'])->name('destroy');
});
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/overview', [AdminDashboardController::class, 'getOverview'])->name('overview');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    Route::group(['prefix' => 'translations', 'as' => 'translations.'], function () {
        ...
        Route::post('/', [TranslationManagerController::class, 'store'])->name('store');
        Route::put('/', [TranslationManagerController::class, 'update'])->name('update');
        Route::get('statistics', [TranslationManagerController::class, 'statistics'])->name('statistics');
        Route::get('missing/{locale}', [TranslationManagerController::class, 'missing'])->name('missing');
        Route::post('sync/{locale}', [TranslationManagerController::class, 'sync'])->name('sync');
        Route::post('export/{locale}', [TranslationManagerController::class, 'export'])->name('export');
        Route::post('import/{locale}', [TranslationManagerController::class, 'import'])->name('import');
    });
});
...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('taxonomies/{taxonomy}/toggle-status', [TaxonomyController::class, 'toggleStatus'])
        ->name('taxonomies.toggle-status')
    ;
    Route::post('taxonomies/bulk-action', [TaxonomyController::class, 'bulkAction'])
        ->name('taxonomies.bulk-action')
    ;
    Route::get('taxonomies/{taxonomy}/export', [TaxonomyController::class, 'export'])
    ...
    Route::post('terms/{term}/toggle-status', [TermController::class, 'toggleStatus'])
