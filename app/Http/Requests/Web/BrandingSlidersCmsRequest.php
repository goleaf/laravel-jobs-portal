...
class BrandingSlidersCmsRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for BrandingSlidersCmsRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'CmsController',
            'method' => 'brandingSliders',
