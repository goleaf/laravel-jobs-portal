...
{{-- <i class="fa-solid fa-calendar-days text-indigo-600 -600 me-2 fs-18"></i> --}}
...
{{-- <div class="desc-box flex justify-between mb-2"> --}}
{{-- <div class="flex items-center mb-3"> --}}
{{-- <i class="fa-solid fa-clock text-indigo-600 -600 me-2 fs-18"></i> --}}
{{-- <p class="fs-14 text-gray-600 mb-0"> --}}
...
{{-- <div class="desc-box flex justify-between mb-2"> --}}
{{-- <div class="flex items-center mb-3"> --}}
{{-- <i class="fa-solid fa-location-dot text-indigo-600 -600 me-2 fs-18"></i> --}}
...
{{-- <div class="desc-box flex justify-between mb-2"> --}}
{{-- <div class="flex items-center mb-3"> --}}
{{-- <i class="fa-solid fa-briefcase text-indigo-600 -600 me-2 fs-18"></i> --}}
    ...
    <div class="flex-1 -12 mb-40">
        <div class="job- bg-white overflow-hidden shadow rounded-lg bg-white shadow rounded -lg overflow-hidden py-30">
            <div class="flex flex-wrap flex justify-content-lg-between">
                ...
                @endif
                <div class="flex-1 -5 mt-3">
                    <i class="fa-solid fa-wallet text-indigo-600 -600 fs-4"></i>
                    <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0" >
                ...
                <div class="flex-1 -5 mt-3">
                    <i class="fa-solid fa-venus text-indigo-600 -600 fs-4"></i>
                    <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0" >
...
<div class="job-desc-right br-10 px-40 bg-gray mt-50">
    ...
    @if (!empty($candidateDetails->careerLevel))
        <div class="desc-box flex justify-between mb-4">
            <div class="desc flex">
                <div class="me-2 w-20">
                    <x-icons.inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium class="w-full h-full" />
                </div>
...
<div class="flex flex-wrap desc-box mt-4">
    <div class="flex-1 md-6 mb-4">
        <div class="flex">
            <div class="me-3 w-20">
                <x-icons.calendar-days class="w-full h-full text-indigo-600-600" />
            </div>
            <div>
    ...
    @if (isset($candidateDetails->expected_salary) && ($candidateDetails->expected_salary != 0))
        <div class="flex-1 md-6 mb-4">
            <div class="flex">
                <div class="me-3 w-20">
                    <x-icons.money class="w-full h-full text-indigo-600-600" />
                </div>
                <div>
    ...
    @if (isset($candidateDetails->experience) && $candidateDetails->experience != 0)
        <div class="flex-1 md-6 mb-4">
            <div class="flex">
                <div class="me-3 w-20">
                    <x-icons.experience class="w-full h-full text-indigo-600-600" />
                </div>
                <div>
    ...
    @if (isset($candidateDetails->gender) && $candidateDetails->gender !== \App\Models\Candidate::DEFAULT)
        <div class="flex-1 md-6 mb-4">
            <div class="flex">
                <div class="me-3 w-20">
                    <x-icons.gender class="w-full h-full text-indigo-600-600" />
                </div>
                <div>
