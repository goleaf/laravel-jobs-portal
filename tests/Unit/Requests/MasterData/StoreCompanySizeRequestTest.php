...
use Tests\TestCase;
use App\Http\Requests\MasterData\StoreCompanySizeRequest;
use App\Models\User;
...
/**
 * Context7 Unit Test for StoreCompanySizeRequest
 * Testing validation rules and authorization
 */
class StoreCompanySizeRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreCompanySizeRequest();
