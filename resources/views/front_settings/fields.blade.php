<div class="flex flex-wrap">
    ...
    <div class="md:w-3/12 flex-1 sm-12">
        ...
        <span class="required"></span>
        {{ Form::text('featured_jobs_price', !empty($frontSettings['featured_jobs_price']) ? $frontSettings['featured_jobs_price'] : 0, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm salary', 'required','min' => 0, 'max' => '50000','placeholder' => __('messages.front_settings.featured_jobs_price'),'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="md:w-3/12 flex-1 sm-12">
        ...
        <span class="required"></span>
        {{ Form::text('featured_jobs_days', $frontSettings['featured_jobs_days'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm salary', 'required','min' => 0, 'max' => '20', 'placeholder' => __('messages.front_settings.featured_jobs_due_days'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    ...
    <div class="md:w-3/12 flex-1 sm-12 mt-5 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('featured_jobs_quota', $frontSettings['featured_jobs_quota'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm salary', 'required','min' => 0, 'max' => '20', 'placeholder' => __('messages.front_settings.featured_jobs_quota'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="md:w-3/12 flex-1 sm-12 mt-5 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('featured_companies_price', $frontSettings['featured_companies_price'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm salary', 'required','min' => 0, 'max' => '50000', 'placeholder' => __('messages.front_settings.featured_companies_price'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="md:w-3/12 flex-1 sm-12 mt-5 mb-5">
        ...
        <span class="required"></span>
        {{ Form::text('featured_companies_days', $frontSettings['featured_companies_days'], ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm salary', 'required','min' => 0, 'max' => '20', 'placeholder' =>__('messages.front_settings.featured_companies_due_days'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")' ]) }}
    </div>
