                        ...
                        <form method="POST" id="addCandidateNewForm"
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="flex-1 md-6 mb-4">
                                    <div class="mb-4">
                                        <label for="" class="fs-16 text-gray-600 mb-2">{{ __('web.common.first_name') }}
                                        ...
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" name="first_name"
                                               id="candidateFirstName" placeholder="{{ __('messages.enter_first_name') }}"
                                               required>
                                    </div>
                                </div>
                                <div class="flex-1 md-6 mb-4">
                                    <div class="mb-4">
                                        <label for="" class="fs-16 text-gray-600 mb-2">{{ __('web.common.last_name') }}
                                            <span class="text-indigo-600 -600">*</span>
                                        </label>
                                        <input type="text" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" name="last_name"
                                               id="candidateLastName" placeholder="{{ __('messages.enter_last_name') }}"
                                               required>
                                    </div>
                                </div>
                                <div class="flex-1 md-12 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" name="email"
                                               id="candidateEmail" placeholder="{{ __('messages.email_address') }}"
                                               required>
                                    </div>
                                </div>
                                <div class="flex-1 md-6 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="password" name="password" placeholder="{{ __('messages.password') }}"
                                               class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" id="candidatePassword"
                                ...
                                <div class="flex-1 md-6 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="password" name="password_confirmation"
                                               class="w-full px-3 py-2 border border-gray-300 border border border-gray-300 -gray-300 -gray-300 rounded -md focus:outline-none focus:ring-2 focus:ring-primary-500 fs-14 text-gray br-10" id="candidateConfirmPassword"
                            ...
                            <div class="flex-1 -12 d-grid my-4">
                                <button type="submit" class="border border-gray-300 bg-transparent" id="btnCandidateSave" data-loading-text="<span class="animate-spin h-5 w-5 border-2 border-current border-t-transparent rounded -full spinner- border border border-gray-300 -gray-300 -sm"></span> {{ __('messages.common.process') }}">
...
@push('scripts')
    @vite('resources/js/components/candidate_register.js')
@endpush
