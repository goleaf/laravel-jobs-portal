...
/**
 * Context7 API Testing Suite
 * Implements MCP best practices for comprehensive API testing
 */
class Context7ApiTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Context7 Pattern: Set up test environment with realistic data
    ...
    /**
     * Context7 Pattern: Test authenticated user endpoint with fluent JSON
     */
    ...
    /**
     * Context7 Pattern: Test public jobs endpoint with caching headers
     */
    ...
    /**
     * Context7 Pattern: Test job show endpoint with relationship loading
     */
    ...
    /**
     * Context7 Pattern: Test authenticated jobs CRUD with validation
     */
    public function test_authenticated_jobs_crud_operations(): void
    {
        ...
        $updateResponse
            ->assertOk()
            ->assertJson(fn (AssertableJson $json) =>
                $json->where('job.title', 'Lead Laravel Developer')
                    ->where('job.id', $jobId)
                    ->etc()
            );
    ...
    /**
     * Context7 Pattern: Test validation errors with detailed assertions
     */
    ...
    /**
     * Context7 Pattern: Test rate limiting functionality
     */
    ...
    /**
     * Context7 Pattern: Test companies endpoint with filtering
     */
    ...
    /**
     * Context7 Pattern: Test health endpoint for monitoring
     */
    ...
    /**
     * Context7 Pattern: Test stats endpoint for analytics
     */
    public function test_stats_endpoint(): void
    {
        ...
        $response
            ->assertOk()
            ->assertJson(fn (AssertableJson $json) =>
                $json->whereType('jobs_count', 'integer')
    ...
    /**
     * Context7 Pattern: Test pagination with cursor-based pagination
     */
    ...
    /**
     * Context7 Pattern: Test response headers for security and caching
     */
    ...
    /**
     * Context7 Pattern: Test error handling for non-existent resources
     */
    ...
    /**
     * Context7 Pattern: Test API versioning compatibility
     */
