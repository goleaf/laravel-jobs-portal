...
/**
 * Universal Form Request for storing OwnerShipType
...
class StoreOwnerShipTypeRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', ownershiptype::class) ?? true;
    }
    ...
    {
        logger()->info('Store validation failed for StoreOwnerShipTypeRequest', [
