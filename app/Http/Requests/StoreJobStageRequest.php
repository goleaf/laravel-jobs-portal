...
class StoreJobStageRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', jobstage::class) ?? true;
    }
    ...
    {
        return [
            'name' => ['required', 'string', 'max:255', 'unique:jobstages,name'],
    ...
    {
        logger()->info('Store validation failed for StoreJobStageRequest', [
