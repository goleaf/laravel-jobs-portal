...
@section('content')
    <div class="job-details-page">
        <!-- start hero section -->
        <section class="hero-section relative bg-flex-1 px-4or-light py-40">
                                        ...
                                        <div class="desc flex me-4 pe-2">
                                            @if (!$isApplied && !$isJobApplicationRejected && !$isJobApplicationCompleted && !$isJobApplicationShortlisted)
                                                @if ($isActive && !$job->is_suspended && \Carbon\Carbon::today()->toDateString() < $job->job_expiry_date->toDateString())
                                                    <button
                                                        class="transition duration-150 ease-in-out flex-1"inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200-outline-dark' }}"
         ...
         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto px-4 mx-auto px-4 mx-auto">
             <div class="flex flex-wrap">
                 ...
                 @if(Session::has('warning'))
                     <div class="md:w-full flex-1 sm-12">
                         <div class="px-4 py-3 rounded-md border border border-gray-300 -gray-300 mb-4 p-4 rounded -md mb-4 warning" role="rounded-md p-4" data-turbo="false">
                             {{ Session::get('warning') }}
                             ...
                             <div class="job- bg-white overflow-hidden shadow rounded-lg bg-white shadow rounded -lg overflow-hidden py-30">
                                 <div class="flex flex-wrap flex justify-content-lg-between">
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-calendar-days text-indigo-600 -600 fs-4"></i>
                                     ...
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-briefcase text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0" >
                                     ...
                                     @endif
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-magnifying-glass text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0">
                                     ...
                                     @if($job->degreeLevel)
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa fa-graduation-cap text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0">
                                     ...
                                     @endif
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-user-plus text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0">
                                     ...
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-calendar-day text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0">
                                     ...
                                     <div class="flex-1 -5 mt-3">
                                         <i class="fa-solid fa-laptop text-indigo-600 -600 fs-4"></i>
                                         <p class="details-page- bg-white shadow rounded -lg overflow-hidden text mb-0">
                                     ...
                                     <div class="flex flex-wrap flex justify-content-lg-between company-overview">
                                         ...
                                         <div class="company-profile flex mb-4">
                                             ...
                                             <div class="desc ms-4">
                                                 ...
                                                 <a href="{{ route('front.', $job->$company->unique_id) }}" class="fs-14 text-indigo-600 -600">
                                             ...
                                             <div class="bg-white shadow rounded -lg overflow-hidden body">
                                                 ...
                                                 <div class="mt-3 flex flex-wrap">
                                                     ...
                                                     <div class="flex-1 -8">
                                                         ...
                                                         <a href="{{ route('front.', $relatedJob->$company->unique_id) }}">
                             ...
                             @if(($getRelatedJobs->count() > 0 ))
                                 <div class="flex flex-wrap justify-center">
                                     <div class="flex-1 -8 text-center">
                                         <a href="{{ route('front.',array('categories'=> $relatedJob->jobCategory->id)) }}"
