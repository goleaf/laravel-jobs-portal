                    ...
                    <div class="find-job position-relative bg-white">
                        <div class="flex flex-wrap items-center justify-content-around m-0">
                            ...
                            <div class="col-xl-2 flex-1 -lg-3 text-center p-xl-1 px-20">
                                <a href="#" wire:click="resetFilter()" class="btn bg-primary-600 text-white hover: bg-primary-600 -700 px-4 py-2 rounded font-medium transition-colors -primary-register block pt-3 pb-3">{{ __('web.reset_filter') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
