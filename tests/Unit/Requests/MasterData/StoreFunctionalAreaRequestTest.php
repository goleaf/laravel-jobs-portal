...
use App\Http\Requests\MasterData\StoreFunctionalAreaRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for StoreFunctionalAreaRequest
 ...
 * @coversNothing
 */
class StoreFunctionalAreaRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreFunctionalAreaRequest;
