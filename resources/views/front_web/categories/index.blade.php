                        ...
                        <div class="hero-content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-center mb-0">
                                    ...
                                    <li class="breadcrumb-item text-indigo-600-600 fs-18" aria-current="page">@lang('web.post_menu.categories')</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            <div class="flex flex-wrap items-center">
                                                ...
                                                <div class="flex-1 -8">
                                                    <div class="bg-white shadow rounded -lg overflow-hidden body ps-xl-0 ps-lg-3">
                                                        <a href="{{ route('front.',array('categories'=> $jobCategory->id)) }}" class="text-gray-600 primary-link-hover">
                                                ...
                                                @else
                                                    <div class="bg-white shadow rounded -lg overflow-hidden desc mt-3">
                                                        <div class="desc flex mt-2">
                                                            <a href="{{ route('front.',array('categories'=> $jobCategory->id)) }}" class="jobs-position  fs-14 mb-0 me-3">
