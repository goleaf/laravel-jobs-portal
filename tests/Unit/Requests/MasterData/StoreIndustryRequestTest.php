...
use App\Http\Requests\MasterData\StoreIndustryRequest;
use App\Models\User;
...
/**
 * Enhanced Unit Test for StoreIndustryRequest
 ...
 * @coversNothing
 */
class StoreIndustryRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new StoreIndustryRequest;
