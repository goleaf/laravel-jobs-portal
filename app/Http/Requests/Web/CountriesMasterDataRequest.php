...
class CountriesMasterDataRequest extends FormRequest
{
    ...
    {
        logger()->warning('Context7 validation failed for CountriesMasterDataRequest', [
