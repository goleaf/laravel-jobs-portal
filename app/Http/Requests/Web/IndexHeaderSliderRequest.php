...
class IndexHeaderSliderRequest extends FormRequest
{
    ...
    {
        logger()->warning('Enhanced validation failed for IndexHeaderSliderRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'HeaderSliderController',
            'method' => 'index',
