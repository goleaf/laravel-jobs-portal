...
/**
 * Enhanced Enhanced Form Request for Post getBlogDetailsByCategory
 * Implements Laravel 12 best practices with Enhanced MCP patterns
 * Auto-generated for Level 4 Complex System Transformation.
 */
class GetBlogDetailsByCategoryPostRequest extends FormRequest
{
    /**
    ...
    {
        logger()->warning('Enhanced validation failed for GetBlogDetailsByCategoryPostRequest', [
            'errors' => $validator->errors()->toArray(),
            'controller' => 'PostController',
            'method' => 'getBlogDetailsByCategory',
