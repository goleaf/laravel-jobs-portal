<div class="flex flex-wrap">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::password('password', ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ','required','min' => '6','max' => '10', 'placeholder' => __('messages.candidate.password')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::password('password_confirmation', ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ','required','min' => '6','max' => '10', 'placeholder' => __('messages.candidate.conform_password')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::text('national_id_card', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ', 'placeholder' => __('messages.candidate.national_id_card')]) }}
    </div>
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        <div class="flex flex-wrap">
            ...
            <div class="md:w-6/12 flex-1 sm-6">
                <div class="flex flex-wrap">
                    <div class="md:w-4/12 flex-1 sm-12 mb-0 pt-1">
                    ...
                    <div class="md:w-4/12 flex-1 sm-12 mb-0 pt-1">
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('messages.candidate.is_verified').':' }}</label><br>
                        <label class="flex items-center form-switch form-switch-sm">
    ...
    <div class="col-xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        {{ Form::textarea('address', null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm address-height', 'rows' => '5','placeholder' => __('messages.candidate.address')]) }}
    </div>
