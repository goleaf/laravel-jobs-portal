<div class="flex flex-wrap">
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        {{ Form::label('company_id', __('messages.company.company_name').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1']) }}<span
                class="required"></span>
        {{ Form::select('company_id', $data['companies'],null, ['id'=>'companyId','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','placeholder' => __('messages.company.select_company'),'text-red-500', 'data-control'=>'select2']) }}
    </div>
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex flex-nowrap">
            {{ Form::select('job_category_id', $data['jobCategory'],null, ['id'=>'jobCategoryId','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','placeholder' => __('messages.company.select_job_category'),'text-red-500', 'data-control'=>'select2']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5 custom-datepicker">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        {{ Form::label('state', __('messages.company.state').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1 ']) }}<span
                class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('state_id', [], null, ['id'=>'stateId','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','placeholder' => __('messages.company.select_state'),'text-red-500', 'data-control'=>'select2']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        {{ Form::label('city', __('messages.company.city').':', ['class' => 'block text-sm font-medium text-gray-700 mb-1 ']) }}<span
                class="required"></span>
        <div class="flex flex-nowrap">
            {{ Form::select('city_id', [], null, ['id'=>'cityId','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','placeholder' => __('messages.company.select_city'),'text-red-500', 'data-control'=>'select2']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
        ...
        <div class="flex flex-nowrap">
            {{ Form::select('jobTag[]',$data['jobTag'], null, ['class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ','id'=>'tagId','multiple'=>true, 'data-control'=>'select2']) }}
            <div class="px-3 py-2 bg-gray-50 border border-gray-300 border-gray-300 border-r-0 rounded -l-md text-gray-500 border border border-gray-300 -gray-300 -0">
    ...
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
         ...
         <span class="required"></span>
         {{ Form::text('experience',  null, ['id'=>'experienceId','class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm','placeholder' => __('messages.company.enter_experience_year'),'text-red-500', 'min' => 0, 'max' => 255, 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
     </div>
    <div class="flex-1 -xl-6 md:w-6/12 flex-1 sm-12 mb-5">
